...
urlpatterns = [
    ...
    path('court_management/', court_management, name='court_management'),  # หน้าเพจจัดการสนาม
    path('booking_management/', booking_management, name='booking_management'),  # หน้าเพจจัดการการจอง
    path('user_management/', user_management, name='user_management'),  # หน้าเพจจัดการผู้ใช้
    ...
    path('delete-court/<int:court_id>/', delete_court, name='delete_court'),  # URL pattern for deleting a court
    path('my-bookings/', my_bookings_view, name='my_bookings'),
    path('update_booking_status/<int:booking_id>/', update_booking_status, name='update_booking_status'),  # เส้นทางใหม่
